...
public class util {
	...
	int jourNaissance = 0;
	do {
		System.out.println("Veuillez donner le jour de votre naissance :");
	...
	int moisNaissance = 0;
	do {
		System.out.println("Veuillez donner le mois de votre naissance :");
		if (entree.hasNextInt()) {
	...
	do {
		System.out.println("Veuillez donner l'année de naissance :");
		if (entree.hasNextInt()) {
